<%@ Page Title="" Language="C#" MasterPageFile="~/Trainer.Master" AutoEventWireup="true" CodeBehind="IntraChatrTrainer.aspx.cs" Inherits="HRMS1.IntraChatrTrainer" %>
...
<h2 class="text-center my-4">Welcome To Intra Chat</h2>
    <div class="form-group">
        ...
        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control w-25"></asp:DropDownList>
    </div>
    <div class="form-group">
