...
namespace HRMS1
{
    public partial class TrRaisedTkt : System.Web.UI.Page
    {
        SqlConnection conn;
        ...
        protected void btnRaiseTicket_Click(object sender, EventArgs e)
        {
            ...
            string file = "TktImgs/" + Path.GetFileName(fileUpload.FileName); DateTime dateTime = DateTime.Now;
            ...
            string query = $"exec insertTicket '{em}', '{raisedToEmail}', '{ticket}', '{file}', '{date}', '{status}', '{sol}'";
